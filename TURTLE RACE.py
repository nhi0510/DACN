...
# VẠCH TRẮNG 2
for i in range(10):
    goto(250 + gap_size, ((170 + gap_size) - (i * gap_size * 2)))
    stamp()

# VẠCH ĐEN 1
color("black")
for i in range(10):
    goto(250, ((170 + gap_size) - (i * gap_size * 2)))
    stamp()
...
if blue_turtle.xcor() > pink_turtle.xcor() and blue_turtle.xcor() > yellow_turtle.xcor() and blue_turtle.xcor() > green_turtle.xcor():
 ...
 # GREEN TURTLE WINS
elif green_turtle.xcor() > blue_turtle.xcor() and green_turtle.xcor() > pink_turtle.xcor() and green_turtle.xcor() > yellow_turtle.xcor():
